      ...
      <div className="footer-1">
        ...
        <div className="footer-1-2">
          <div className="footer-1-1">
            <a
              href="https://www.facebook.com/profile.php?id=100093700947943"
              rel="noreferrer"
              target="_blank"
            >
          ...
          <div className="footer-1-1">
            <a
              href="https://www.instagram.com/wedesi_mtl/"
              rel="noreferrer"
              target="_blank"
            >
        ...
        <div className="footer-1-3">
          ...
          <span className="footer-1-3-1">
            <a href="https://shikshaway.com/" rel="noreferrer" target="_blank">
              Powered by <span className="shikshaway">shikshaway</span>
            </a>
          </span>
        </div>
      </div>
