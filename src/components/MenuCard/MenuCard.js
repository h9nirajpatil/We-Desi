    ...
    <div className="menucard">
        ...
        <div className="menucard-container">
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              ...
              <p className="text-white text-start">
                Deep fried mashed potato cutlet mixed with different spices and
                topped with yogurt, tamarind chutney, mint chutney, onions and
                tomatoes. Perfect on the go!
              </p>
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              ...
              <p className="text-white text-start">
                Deep fried lentil fritters dunked in creamy yogurt, topped with
                different kinds of sweet spicy chutneys
              </p>
              <p className="text-white text-start price">$6.99</p>
            </div>
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              ...
              <p className="text-white text-start">
                crispy fritters made with onions, potatoes, spinach gram flour,
                spices and herbs
              </p>
              <p className="text-white text-start price">$ 5.49</p>
            </div>
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              ...
              <p className="text-white text-start">
                ...
                filling, tamarind chutney and spicy masala pani (water). Perfect
                on the go
              </p>
              <p className="text-white text-start price">$6.99</p>
            </div>
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              ...
              <p className="text-white text-start">
                Spicy potato filled Nan mixed with coriander, mint and many more
                spices. Served with 2 Kulchas, Chana and Roasted Tamarind
                Chutney
              </p>
              <p className="text-white text-start price">$ 7.99</p>
            </div>
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              ...
              <p className="text-white text-start">
                Puff pastry filled with a delectable moong dal mixture and deep
                fried.
              </p>
              <p className="text-white text-start price">$ 5.99</p>
            </div>
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              ...
              <p className="text-white text-start">
                Spiced mixture of mashed Vegetables in a thick Gravy, served hot
                with a soft white Bread cheese extra
              </p>
        ...
        <div className="menucard-container">
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              ...
              <p className="text-white text-start">
                Grilled homemade cheese pieces, peppers, and onions with cooking
                cream
              </p>
              <p className="text-white text-start price">$ 12.99</p>
            </div>
        ...
        <div className="menucard-container">
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              ...
              <p className="text-white text-start">
                Marinated soya chaap in yogurt, Indian spices, onion and wrapped
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              ...
              <p className="text-white text-start">
                Cottage cheese marinated in yogurt, Indian spices, char-grilled
                with onions and wrapped served with mint chutney
              </p>
              <p className="text-white text-start price">$ 10.99</p>
            </div>
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              ...
              <p className="text-white text-start">
                Chilli paneer, char-grilled with onions and wrapped served with
                mint chutney
              </p>
              <p className="text-white text-start price">$ 10.99</p>
            </div>
        ...
        <div className="menucard-container">
          <div class="menucards">
            <div className="menucards-1 mt-2">
              ...
              <p className="text-white text-start">
                Rounded soft dough steamed/fried, stuffed with vegetable, served
                with spicy
              </p>
              <p className="text-white text-start price">$ 10.99</p>
            </div>
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              ...
              <p className="text-white text-start">
                Wok tossed rice with garden fresh vegetables, soy sauce, chilli
                sauce and spices
              </p>
              <p className="text-white text-start price">$ 6.99</p>
            </div>
      ...
      <div>
        ...
        <div className="menucard-container">
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              ...
              <p className="text-white text-start">
                Rice flour pancakes served with sambar, Chutney & stuffed inside
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              ...
              <p className="text-white text-start">
                Crispy rice and lentil crepe and a spiced masala potato filling
        ...
        <div className="menucard-container">
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              <p className="text-white text-start first-text">Chilli Paneer</p>
              <p className="text-white text-start">
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              <p className="text-white text-start first-text">Paneer Makhani</p>
              <p className="text-white text-start"></p>
              <p className="text-white text-start price">$ 13.99</p>
            </div>
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              ...
              <p className="text-white text-start">
                Yellow lentil cooked with various spices garnished with tomato.
              </p>
              <p className="text-white text-start price">$ 8.99</p>
            </div>
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              <p className="text-white text-start first-text">Bhindi Masala</p>
              <p className="text-white text-start">
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              <p className="text-white text-start first-text">Mutter Paneer</p>
              <p className="text-white text-start">
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              <p className="text-white text-start first-text">Paneer Kadhai</p>
              <p className="text-white text-start">
                Home made cheese cubes cooked with bell pepper, onions, garlic,
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              <p className="text-white text-start first-text">Paneer Pasanda</p>
              <p className="text-white text-start">
                Stuffed indian cheese with nuts and khoa, cooked in rich tomato
                gravy.
              </p>
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              <p className="text-white text-start first-text">Paneer Bhurji</p>
              <p className="text-white text-start">
                Homemade Grated paneer sauteed with onion, tomato, bell pepper,
                and spices
              </p>
              <p className="text-white text-start price">$ 14.99</p>
            </div>
        ...
        <div className="menucard-container">
          <div class="menucards">
            <div className="menucards-1 mt-2">
              ...
              <p className="text-white text-start">
                Whole wheat bread stuffed with masala potatoes and spices cooked
                on tawa and topped with butter.
              </p>
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              <p className="text-white text-start first-text">Paneer Prantha</p>
              <p className="text-white text-start">
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              <p className="text-white text-start first-text">Gobhi Prantha</p>
              <p className="text-white text-start">
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              <p className="text-white text-start first-text">Makki di Roti</p>
              <p className="text-white text-start">
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              <p className="text-white text-start first-text">Lacha Prantha</p>
              <p className="text-white text-start">
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              <p className="text-white text-start first-text">Tandoori Roti</p>
              <p className="text-white text-start">
        ...
        <div className="menucard-container">
          <div class="menucards">
            <div className="menucards-1 mt-2">
              ...
              <p className="text-white text-start">
                Chef’s choice of 3 vegetables served with rice, naan and bread.
              </p>
              <p className="text-white text-start price"> $ 9.99</p>
            </div>
        ...
        <div className="menucard-container">
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              ...
              <p className="text-white text-start">
                ndian basmati rice cooked with turmeric powder, onions, peas and
                garnished with onions and coriander.
              </p>
              <p className="text-white text-start price">$ 5.99</p>
            </div>
        ...
        <div className="menucard-container">
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              <p className="text-white text-start first-text">Kulfi Falooda</p>
              <p className="text-white text-start"></p>
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              <p className="text-white text-start first-text">Rabri Falooda</p>
              <p className="text-white text-start"></p>
              <p className="text-white text-start price">$ 7.99</p>
            </div>
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              <p className="text-white text-start first-text">Paan Ice Cream</p>
              <p className="text-white text-start"></p>
              <p className="text-white text-start price">$ 5.99</p>
            </div>
        ...
        <div className="menucard-container">
          <div class="menucards">
            <div className="menucards-1 mt-2">
              <p className="text-white text-start first-text">Royal Falooda</p>
              <p className="text-white text-start"></p>
              <p className="text-white text-start price"> $ 9.99</p>
            </div>
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              <p className="text-white text-start first-text">Chikkoo Shake</p>
              <p className="text-white text-start"></p>
              <p className="text-white text-start price">$ 9.99</p>
            </div>
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              <p className="text-white text-start first-text">Green Tea 3.99</p>
              <p className="text-white text-start"></p>
              <p className="text-white text-start price">$ 3.99</p>
            </div>
          ...
          <div class="menucards">
            <div className="menucards-1 mt-2">
              <p className="text-white text-start first-text">Kashmiri Chai</p>
              <p className="text-white text-start"></p>
              <p className="text-white text-start price">$ 4.99</p>
            </div>
