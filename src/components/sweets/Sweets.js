  ...
  return (
    <div className="Sweets">
      ...
      <div className="d-flex flex-column mt-2 mb-2">
        ...
        <p className="sweets-text-p">
          Laddu is a spherical sweet from the Indian subcontinent made of
          various ingredients and sugar syrup or jaggery.
        </p>
      ...
      <div className="d-flex flex-column mt-2 mb-2">
        ...
        <p className="sweets-text-p">
          made from ball shaped dumplings made from paneer and cooked in a light
          sugar syrup. Rasgulla quantity.
        </p>
      ...
      <div className="d-flex flex-column mt-2 mb-2">
        ...
        <p className="sweets-text-p">
          Easy, quick and tasty recipe of carrot burfi made with carrots, milk
          powder, ghee sugar and cardamom powder.
        </p>
      ...
      <div className="d-flex flex-column mt-2 mb-2">
        ...
        <p className="sweets-text-p">
          Creamy and rich peda is a delightfully sweet fudge-like confection
          often found in Indian shops and made traditionally with khoya.
        </p>
        <text className="sweets-text">$8/lb</text>
      </div>
      <div className="d-flex flex-column mt-2 mb-2">
        ...
        <p className="sweets-text-p">
          There are both savory sandwiches, such as deli meat sandwiches, and
          sweet sandwiches, such as a peanut butter and jelly.
        </p>
      ...
      <div className="d-flex flex-column mt-2 mb-2">
        ...
        <p className="sweets-text-p">
          Cham cham mithai is made with fresh chenna and pressure cooked in
          thick sugar syrup.
        </p>
        <text className="sweets-text">$9/lb</text>
      </div>
      <div className="d-flex flex-column mt-2 mb-2">
        ...
        <p className="sweets-text-p">
          Khoya barfi is a fudgy sweet made with fresh condensed milk, cubed and
      ...
      <div className="d-flex flex-column mt-2 mb-2">
        ...
        <p className="sweets-text-p">
          made of milk, sugar, ghee, and an acidic agent such as lemon juice.
        </p>
        <text className="sweets-text">$10/lb</text>
      </div>
      <div className="d-flex flex-column mt-2 mb-2">
        ...
        <p className="sweets-text-p">
          made with condensed milk solids, sugar & cardamom powder. Make it with
          paneer or ricotta cheese instantly.
        </p>
        <text className="sweets-text">$10/lb</text>
      </div>
      <ScrollToTopButton />
