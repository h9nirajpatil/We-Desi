        ...
        <div className='wrapper'>
            <div className="video-container position-relative">
                ...
                <div className="text-overlay1" ref={textOverlayRef1}>
                    <text>Wedesi is the first Indian restaurant in Montreal to bring the Indian sweets and authentic street foods from all over India under one roof</text>
                    {/* Add any other text or components as needed */}
                </div>
                <NavLink
                    to="/menu"
                ...
                >
                    <div className='elementor-button-wrapper'><a className='elementor-button'>Explore Menu</a></div>
                </NavLink>
                <p className="itemdiamond-square-home"></p>
            </div>
            <div className='section-2'>
                <div className='section-2-first p-5 position-relative'>
                    <div ref={textBestOverlayRef} className={`best-desi-text ${animate ? 'animate' : ''}`}><text>The Best Desi Food</text></div>
                    <img className='' src={divider} alt='divider' />
                    <p className='section-2-text-paragraph'>
                        Wedesi is the first Indian restaurant in Montreal to bring the Indian sweets and authentic street foods from all over India under one roof. If you want to celebrate happiness or take a stroll through Indian streets, you have come to the right place.
                    </p>
                    <NavLink
                        to="/contact"
                        className="nav-item"
            ...
            <p className="diamond-square-upper2-home"></p>
                <div ref={textOverlayRef3} className={`Delicacies ${animate ? 'animate' : ''}`}>
                    <text>Featured Delicacies</text>
                </div>
                <text className='text-white' style={{ zIndex: 10, fontSize: '1.5vw', fontWeight: 500, marginTop: '-8vh' }}>Fresh From the kitchen</text>
                <img className='divider-image1' src={divider} alt='divider' />
                <text className='text-white' style={{ zIndex: 10, fontSize: '1.5vw', fontWeight: 500, marginTop: '10vh' }}>All Food Are Best in class</text>
                ...
                <div className='row1'>
                    <div className='column p-4 chatpatachat'>
                        <div className='w-50 p-5'>
                            ...
                            <p className='text-white'>Family of savoury snacks served at roadside tracks from stalls or food carts</p>
                        </div>
                        <div className='image-container'>
                            <img className='rotate-on-hover animate-text-happy-hours-right' src={chaatCir} alt='chaatCir' />
                        </div>
                    </div>
                    <div className='column p-4'>
                        <div className='w-50 p-5'>
                            <text className='text-section-4'>Tikka & Snacks</text>
                            <p className='text-white'>Flavor-packed appetizer in which marinated paneer/soya pieces are grilled until crisp and slightly charred</p>
                        </div>
                        <div className='image-container'>
                            <img className='rotate-on-hover animate-text-happy-hours-left' src={tikka} alt='tikka' />
                        </div>
                    </div>
                </div>
                <div className='row1'>
                    <div className='column p-4'>
                        <div className='w-50 p-5'>
                            ...
                            <p className='text-white'>Popular sandwich made from potato patty/tikka that are placed between two halves of a bun or tortilla</p>
                        </div>
                        <div className='image-container'>
                            <img className='rotate-on-hover animate-text-happy-hours-right' src={burger} alt='burger' />
                        </div>
                    </div>
                    <div className='column p-4'>
                        <div className='w-50 p-5'>
                            <text className='text-section-4'>South Indian</text>
                            <p className='text-white'>Cuisines of five South Indian states namely Tamil Nadu, Karnataka, Kerala, Andhra Pradesh and Telangana</p>
                        </div>
                        <div className='image-container'>
                            <img className='rotate-on-hover animate-text-happy-hours-left' src={south} alt='south' />
                        </div>
                    </div>
                </div>
                <div className='row1'>
                    <div className='column p-4'>
                        <div className='w-50 p-5'>
                            ...
                            <p className='text-white'>Indian breads cooked on tawa or in clay oven</p>
                        </div>
                        <div className='image-container'>
                            <img className='rotate-on-hover animate-text-happy-hours-right' src={naan} alt='naan' />
                        </div>
                    </div>
                    <div className='column p-4'>
                        <div className='w-50 p-5'>
                            <text className='text-section-4'>Indo Chinese</text>
                            <p className='text-white'>Stir-fried in a wok, Chino-Indian food takes Chinese culinary styles and adds flavours familiar to the Indian palate</p>
                        </div>
                        <div className='image-container'>
                            <img className='rotate-on-hover animate-text-happy-hours-left' src={chinese} alt='chinese' />
                        </div>
                    </div>
                </div>
                <NavLink
            ...
            <div className='section-5'>
                ...
                <div className='section-5-2'>
                    <text className='animate-text-happy-hours'>Enjoy 30% Off on All Drinks</text>
                </div>
                <div className='section-5-3'>
                    <text className='animate-text-happy-hours1'>Every Thursday, 4PM – 7PM</text>
                </div>
                ...
                <NavLink
                    ...
                    activeClassName="active"
                >
                    <button className='reservation1 text-white' style={{ zIndex: 11, marginBottom: '5vh', marginTop: '40vh' }}>View menu</button>
                </NavLink>
            ...
            <div className='section-6'>
                <div className='section-6-1'>
                    <text className='animate-text-happy-hours1'>They All Love Our Food</text>
                </div>
                <img className='divider-image1' src={divider} alt='divider' />
                <div className='section-6-2'>
                    <text className='animate-text-happy-hours1'>The outstanding taste and presentation of our food have earned us a loyal following of satisfied customers.</text>
                </div>
            </div>
            <div className='section-7'>
                <div className='card'>
                    <text className='section-7-text'>"I had a pleasant dining experience at this sweets and veg restaurant!!"</text>
                    <div className='mt-5'>
                ...
                <div className='card'>
                    <text className='section-7-text'>"it has quickly become one of my favorite places to dine.!!"</text>
                    <div className='mt-5'>
                ...
                <div className='card'>
                    <text className='section-7-text'>"I always visit here, and they always surprise me."</text>
                    <div className='mt-4'>
                ...
                <div className='card'>
                    <text className='section-7-text'>"The sweets are also heavenly, with a wide range of traditional and innovative desserts"</text>
                    <div className='mt-5'>
